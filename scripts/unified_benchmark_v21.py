...
def run_experiment_task(task_args):
    ...
    # v21: ensure use_nsa=True and iterations/epochs are sufficient
    params = {"iterations": 50, "epochs": 150, "energy_type": energy_type, "mixing_algorithm": mixing_algorithm, "use_nsa": True, "positivity": "positive", "nsa_w": 0.5, "sparseness_quantile": 0.5}
...
def run_unified_benchmark(n_seeds=20, workers=None):
    ...
    print(f"Starting benchmark (v21) with {len(tasks)} tasks...")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run v21 parallel benchmark")
