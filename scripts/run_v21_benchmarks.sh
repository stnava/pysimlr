...
/Users/stnava/venvs/ants/bin/python scripts/unified_benchmark.py --n-seeds 5 --workers 6 > synthetic_v21.log 2>&1 &
SYNTH_PID=$!

echo "Starting Real Benchmark v21 (5 seeds, ~640 tasks) in background..."
/Users/stnava/venvs/ants/bin/python scripts/unified_real_benchmark.py --n-seeds 5 --workers 6 > real_v21.log 2>&1 &
REAL_PID=$!
